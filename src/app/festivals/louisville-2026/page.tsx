    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black font-sans">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <h1 className="text-3xl md:text-4xl font-bold text-zinc-900 dark:text-zinc-50 text-center">
          2026 Magical Midwinter Festival
        </h1>
        <p className="mt-6 text-lg text-zinc-600 dark:text-zinc-400 text-center">
            Our future event to be help sometime this year in louisville! This is placeholder body text for the festival page. Replace with your own content when ready.
        </p>
      </main>
    </div>
  );
